...
export class RiskAssessmentDialogComponent implements OnInit {
  ...
  addRiskAssessment(){
    if(!this.editData){
      if(this.riskAssessmentForm.valid){
        this.riskAssessmentService.postRiskAssessment(this.riskAssessmentForm.value)
        .subscribe({
          next:(res)=>{
  ...
  updateRiskAssessment(){
    this.riskAssessmentService.putRiskAssessment(this.riskAssessmentForm.value,this.editData.id)
    .subscribe({
      next:(res)=>{
